 ...
 *
 * The SQL dialect is not part of this configuration - it is implied by the JDBC URL. A PostgreSQL
 * URL ({@code jdbc:postgresql://host:5432/db}) is what the bundled driver and the JDBI Postgres
 * plugin are built for, but nothing here hard-codes that choice.
 *
 ...
 * @param minimumIdle the number of connections the pool tries to keep idle, between {@code 0}
 *     and {@code maximumPoolSize}
...
public record DatabaseConfig(
     ...
     */
    public static Builder builder(final String jdbcUrl) {
    ...
    public static DatabaseConfig of(
            final String jdbcUrl, final @Nullable String username, final @Nullable String password) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer minimumIdle;
         ...
         * @return this builder
         */
        public Builder password(final @Nullable String password) {
         ...
         * @return this builder
         */
        public Builder logSql(final boolean logSql) {
            this.logSql = logSql;
            return this;
        }
